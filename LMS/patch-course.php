...
require_once '../backend/courseController/getCourse.php';
...
<body style="background-color: #f4f5f7;">
  ...
  <div id="main-wrapper">
    ...
    <!-- ============================================================== -->
<?php
echo '<form class="jotform-form" action="../backend/courseController/updateCourse.php?id='.$_GET['id'].'" method="post" enctype="multipart/form-data" name="form_220715805341550" id="220715805341550" accept-charset="utf-8" autocomplete="on">';
?>
  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line" data-type="control_textbox" id="id_5">
        ...
        <?php  
        echo'<input type="text" value="'.$result['course_title'].'" id="input_5" name="title" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value="" placeholder=" " data-component="textbox" aria-labelledby="label_5" />';
        ?>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_10">
        ...
        <?php  
        echo'<input type="text" value="'.$result['course_owner'].'" id="input_10" name="owner" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value="" data-component="textbox" aria-labelledby="label_10" />';
        ?>
        </div>
      </li>
      <li class="form-line" data-type="control_number" id="id_11">
        ...
        <?php  
        echo'<input type="number" value="'.$result['course_duration'].'" id="input_11" name="duration" data-type="input-number" class=" form-number-input form-textbox" data-defaultvalue="" style="width:310px" size="310" value="" placeholder="ex: 23" data-component="number" aria-labelledby="label_11" step="any" />';
        ?>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_10">
        ...
        <div id="cid_10" class="form-input-wide" data-layout="half">
          <textarea id="input_10" name="desc" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px;height:120px" size="310" value="" data-component="textbox" aria-labelledby="label_10" ><?php echo $result['course_description']; ?></textarea>
        </div>
      </li>
