...
$category = $_POST['r'];
$query = $conn->query("SELECT * FROM courses WHERE course_category = '$category'");
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 pb-4">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											<li class="breadcrumb-item"><a href="full-width-course.php">Courses</a></li>
											<li class="breadcrumb-item active" aria-current="page"><a href="#" class="m_title"><?php echo $category; ?></a></li>
										</ol>
									</nav>
								</div>
							</div>
                                                ...
                                                while($result = $query->fetch()){
                                                    ...
                                                    <div class="dashboard_single_course_thumb">
                                                        ...
                                                        <div class="dashboard_action">
															<a href="vedio-play.php?vedio='.$result['video'].'" class="btn btn-ect" target="_blank">View</a>
                                                    ...
                                                    <div class="dashboard_single_course_caption">
                                                        <div class="dashboard_single_course_head">
                                                            <div class="dashboard_single_course_head_flex">
                                                                <span class="dashboard_instructor"><h3>'.$result['course_title'].'</h3></span>
                                                                <h5 class="dashboard_course_title">'.$result['course_owner'].'</h5>
