								...
								<div class="col-lg-6 col-md-7 position-static p-4">
									<div class="log_wraps">
										...
										<div class="log__heads">
											<h4 class="mt-0 logs_title">Confirmation <span class="theme-cl">Code</span></h4>
										</div>
										...
										<div class="form-group">
											...
											<input type="number" name="code" class="form-control" placeholder="123456">
										</div>
										
										<div class="form-group">
											<input type="submit"  value="Confirm code" style="background-color: #0F52BA" class="btn btn_apply w-100">
										</div>
										</form>
